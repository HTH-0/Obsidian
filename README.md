다음은 가독성을 높이고 깔끔하게 정리한 `README.md` 파일이야.  
...
이 레포지토리는 **옵시디언(Obsidian)**을 백업하고 관리하기 위해 사용됩니다.

---

## 🚀 옵시디언 사용 방법
1. [옵시디언 공식 사이트](https://obsidian.md/)에서 다운로드
2. 새 **Vault(보관함)** 생성 또는 기존 Vault 열기
...
## 📌 주요 테마 바로가기  
테마별로 정리된 주요 폴더를 클릭하여 확인할 수 있습니다.  
