...
<details>
  ...
  📁 [19 IO](https://github.com/HTH-0/Obsidian/tree/master/JAVA/19.IO)
  📁 [20 파일 입출력](https://github.com/HTH-0/Obsidian/tree/master/JAVA/20.파일입출력)
  📁 [20 파일 입출력](https://github.com/HTH-0/Obsidian/tree/master/JAVA/20.파일 입출력)
  📁 [21.JDBC](https://github.com/HTH-0/Obsidian/tree/master/JAVA/21.JDBC)
  📁 [22.Socket](https://github.com/HTH-0/Obsidian/tree/master/JAVA/22.Socket)
  📁 [23.Thread](https://github.com/HTH-0/Obsidian/tree/master/JAVA/23.Thread)
  📁 [24.송수신](https://github.com/HTH-0/Obsidian/tree/master/JAVA/24.송수신)
...
### 🚀 옵시디언 사용 방법  
1. [옵시디언 공식 사이트](https://obsidian.md/)에서 다운로드  
2. 새로운 **Vault(보관함)**을 생성하거나 기존 Vault 열기  
3. Markdown 형식으로 노트 작성 및 관리  
4. 플러그인 및 테마를 활용하여 기능 확장 가능  
